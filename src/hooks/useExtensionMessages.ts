...
/** Persist the full seat assignment + appearance snapshot for every
 * non-subagent character. Shared with OfficeCanvas's manual drag-and-drop
 * path so a seat move doesn't silently drop hueShift from the saved record. */
