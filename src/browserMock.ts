...
// mockPayload is populated once by initBrowserMock() in main.tsx. If this
// module gets partial-HMR'd, the new copy starts with mockPayload=null and
// dispatchMockMessages will no-op, leaving the app in the broken-empty state.
// Force a full reload on edit.
