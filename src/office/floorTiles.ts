...
// Module-level sprite store won't survive a partial HMR swap (new module →
// fresh empty array, no one re-sends `floorTilesLoaded`). Force a full reload
// on edit so assets get redecoded cleanly.
